...
private slots:
    ...
    void displayAbout();
    //! Открывает URL https://e.sfu-kras.ru
    void openURL ();
    //! Открывает окно с лотереей
    void openLottery();
    //! Выводит окно выбора файла и сохраняет в файл заметки в произвольной текстовой форме.
    bool saveAsText();
    ...
    //! Выход из прошраммы
    void exit ();
    //! Изменяет видимость элементов связанных с записной книжкой.
    void VisibleElements(bool visible);
    //! Вызывает окно редактирования заметки, вызывает метод, отвечающий за обновление её атрибутов.
