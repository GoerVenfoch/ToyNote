...
public:
    ...
    */
    ...
    QString title();
    //! Устанавливает значений полей окна редактирования равными атрибутам заметки и обновляет дату редактирования.
    void edit(QString s1, QString s2);
    //! Возвращает номер иконки заметки
    int SetNumberRadiobutton();
public slots:
